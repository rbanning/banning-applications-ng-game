...
import { Observable, BehaviorSubject, forkJoin, catchError, throwError } from 'rxjs';

import { ISearchResult, UnsplashService, BannAppsUnsplashService, ToastService } from '@app/core/services';
import { parseHttpError, httpErrorToString } from '@app/shared/common';
import { IGamePhoto, PatchDto, IPatchDto } from '@app/shared/models';

@Component({
  selector: 'app-unsplash-builder',
  templateUrl: './unsplash-builder.component.html',
  styleUrls: ['./unsplash-builder.component.css']
})
export class UnsplashBuilderComponent implements OnInit {
